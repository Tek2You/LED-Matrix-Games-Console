...
Event::Event()
    : on_entry_(false), flags_(0), button_up_(PortPin(PortPin::C, 2), 10), button_down_(PortPin(PortPin::C, 1), 10),
      button_right_(PortPin(PortPin::C, 3), 10), button_left_(PortPin(PortPin::C, 0), 10),
      button_stop_(PortPin(PortPin::B, 1), 10)
