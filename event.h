...
public:
    Event();
    inline bool buttonUpChanged(){return event_ & BTN_UP_CHANGE;} const
    inline bool buttonDownChanged(){return event_ & BTN_DOWN_CHANGE;} const
    inline bool buttonRightChanged(){return event_ & BTN_RIGHT_CHANGE;} const
    inline bool buttonLeftChanged(){return event_ & BTN_LEFT_CHANGE;} const

    inline bool buttonUpState(){return event_ & BTN_UP;} const
    inline bool buttonDownState(){return event_ & BTN_DOWN;} const
    inline bool buttonRightState(){return event_ & BTN_RIGHT;} const
    inline bool buttonLeftState(){return event_ & BTN_LEFT;} const
